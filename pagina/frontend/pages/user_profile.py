...
with column2:
    ...
    community = st.selectbox(label="Comunidad", options=utils.communities, index=0, key="community_select")
    st.session_state["autonomous_community"] = utils.communities[community]
...
if not grid_data.empty:
    ...
    st.markdown("<p style='text-align: center; color: #000000;'>Vaya, parece que aún no tienes propiedades guardadas</p>", unsafe_allow_html=True)
