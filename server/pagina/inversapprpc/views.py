...
def update_properties(properties, salary, age, savings, max_age, interest_rate, autonomous_community):
    ...
    #properties = properties[properties.apply(lambda x: check_community(zones, x['city'], x['address'], autonomous_community), axis=1)]
    ...
    properties['profitability'] = properties.apply(lambda x: profitability(x, savings), axis=1)
...
def profitability(house, initial_amount):
